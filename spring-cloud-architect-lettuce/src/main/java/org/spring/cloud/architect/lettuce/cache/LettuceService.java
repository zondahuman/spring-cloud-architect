...
public class LettuceService {
    ...
    public boolean acquireLock(String lockKey, long lockExpireTime){
            ...
            if (acquire) {
                ...
                if (Objects.nonNull(value) && value.length > 0) {
                    ...
                    if (expireTime < System.currentTimeMillis()) {
                        // 如果锁已经过期
                        byte[] oldValue = connection.getSet(lockKey.getBytes(), String.valueOf(System.currentTimeMillis() + lockExpireTime + 1).getBytes());
                        // 防止死锁
        ...
        try {
            ...
            for (;;) {
                ...
                String result = commands
                        ...
                        .sync()
                        .set(key.getBytes(), value.getBytes(), SetArgs.Builder.nx().ex(10));
