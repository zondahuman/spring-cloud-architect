 ...
 */
public class GetIdHystrixTest {
    private static final String httpUrl = "http://localhost:8080/feign/getIdHystrix";
//    private static final String httpUrl = "http://10.96.91.192:9000/feign/getIdHystrix";


    @Test
    public void testGetIdHystrix() {
        try {
